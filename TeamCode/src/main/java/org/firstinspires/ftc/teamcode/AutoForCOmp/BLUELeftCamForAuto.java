...
@Autonomous
public class BLUELeftCamForAuto extends LinearOpMode
{
    ...
    public static double STRAFERIGHT1 = 5;
    ...
    public void runOpMode()
    {
        ...
        Trajectory Part5 = drive.trajectoryBuilder(turn3.end())
                ...
                .build();
        Trajectory Part6 = drive.trajectoryBuilder(turn3.end())
                .forward(5) //will need to be change
                .build();
...
//rep wait for start
        ...
        }else if(tagOfInterest.id == MIDDLE){ //2  Placement is correct
            drive.followTrajectory(Part1);
            drive.followTrajectory(Part1_1);
            drive.followTrajectory(Part1_2);
            drive.followTrajectorySequence(turn1);
        ...
        }else if (tagOfInterest.id == RIGHT){ //3  Placement is correct
            drive.followTrajectory(Part1);
            drive.followTrajectory(Part1_1);
            drive.followTrajectory(Part1_2);
            drive.followTrajectorySequence(turn1);
